...
public class JavaProject extends JFrame implements ActionListener {
    ...
    void set() {
        ...
        if (current == 10) {
            l.setText(
                    "Que11:Which country has announced a contribution of USD 1 million to the COVID-19 ASEAN Response Fund?");
        ...
        if (current == 12) {
            l.setText(
                    "Que13:hich country has introduced a Veto Power on any agreements entered with foreign countries?");
        ...
        if (current == 13) {
            l.setText(
                    "Que14:Which country under its ‘Data Sonification’ program, extracted the sound of important phenomena of the universe?");
            jb[0].setText("India");
            jb[1].setText("China");
        ...
        if (current == 16) {
            l.setText(
                    "Que17:Which country test-fired a nuclear-capable surface-to-surface ballistic missile named ‘Shaheen-III’?");
            jb[0].setText("Iran");
        ...
        if (current == 18) {
            l.setText(
                    "Que19:Which country recently reported its first known human death of the rare ‘Monkey B virus’?");
            jb[0].setText("USA");
            jb[1].setText("China");
        ...
        if (current == 19) {
            l.setText(
                    "Que20:Which country has become the first country in the world to manufacture fossil-free steel?");
        ...
        if (current == 21) {
            l.setText(
                    "Que22:Which nation won the maximum number of medals in the 2018 ISSF World Shooting Championships?");
            jb[0].setText("Sweden");
